                        ...
                        <table>
                            ...
                            <?php //
                                 if(isset($_GET['id'])){
                                    ...
                                    from product, category where product.cat_id = category.cat_id and product.branch_name = branch.branch_name '$id'=category.cat_id ");
            
                                }else{
                                $result = pg_query($conn,"SELECT product.product_id, product.product_name, product.price, product.pro_qty, product.pro_image, category.cat_name, branch.branch_name 
                                    from product, category where product.cat_id = category.cat_id and product.branch_name = branch.branch_name");
                                }
